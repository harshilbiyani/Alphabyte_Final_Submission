...
class _MyEventsSectionState extends State<MyEventsSection> {
      ...
      children: [
        ...
        SizedBox(
          ...
          child: events.isEmpty 
              ? Center(child: Text("No events found", style: TextStyle(color: Colors.white.withOpacity(0.4))))
              : ListView.builder(
                  scrollDirection: Axis.horizontal,
                  padding: const EdgeInsets.symmetric(horizontal: 20),
                  itemCount: events.length,
                  itemBuilder: (context, index) => _buildMiniEventCard(events[index]),
          ),
        ),
      ],
    );
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: _getStatusColor(_selectedTabIndex).withOpacity(0.2),
  ...
  Color _getStatusColor(int index) {
    switch (index) {
      case 0: return const Color(0xFFC6FF33); // Registered (Green)
      case 1: return AppColors.primary;       // Attended (Purple)
      case 2: return Colors.grey;             // Past
